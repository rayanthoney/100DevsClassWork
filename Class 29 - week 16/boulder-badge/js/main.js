...
const bulbasaurCandy = 16 - 5;
const caterpieCandy = 7 - 1;
const weedleCandy = 7 - 1;
...
function canCharmanderBattle(Ctemp) {
  if (cTemp > 0) return `Charmander can fight`;
  return `Charmander can't fight, too cold`;
}
//Loops
//You have joined an undeground pokemon leauge. In this league, trainers can use any number of pokemon. Print to the console "Pikachu I choose you" x times where x is the number of pokemon the trainer you are battling has in their party

function numOfPokemon(n) {
  for (let i = 0; i < n; i++) console.log('Pikachu I choose you');
}
